...
\section{Publications}
  ...
  \resumeSubHeadingListStart
    \resumePubheading{BRAIxDet: Learning to Detect Malignant Breast Lesion with Incomplete Annotations}{Yuanhong Chen, Yuyuan Liu, Chong Wang, Michael Elliott, Chun Fung Kwok, Yu Tian, \textbf{Fengbei Liu}, Helen Frazer, Davis J McCarthy, Gustavo Carneiro}{Medical Image Analysis 2023}
    \resumePubheading{A Closer Look at Audio-Visual Semantic Segmentation}{Yuanhong Chen, Yuyuan Liu, Hu Wang, \textbf{Fengbei Liu}, Chong Wang, Gustavo Carneiro}{CVPR 2024}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeArxivheading{Partial Label Supervision for Agnostic Generative Noisy Label Learning}{\textbf{Fengbei Liu}, Chong Wang, Yuanhong Chen, Yuyuan Liu, Gustavo Carneiro}{}
    ...
    \resumeArxivheading{Knockout: A simple way to handle missing inputs}{Minh Nguyen, Batuhan K. Karaman, Heejong Kim, Alan Q. Wang, \textbf{Fengbei Liu}, Mert R. Sabuncu}{}
    \resumeArxivheading{Mixture of Gaussian-distributed Prototypes with Generative Modelling for Interpretable and Trustworthy Image Recognition}{Chong Wang, Yuanhong Chen, \textbf{Fengbei Liu}, Davis James McCarthy, Helen Frazer, Gustavo Carneiro}{}
